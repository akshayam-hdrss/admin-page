...
import "../Doctor/Doctor-A/DoctorName.css";
import profile from "../../assets/Doctors_img.webp";
import {
  getDoctorsByTraditionalId,
  createDoctor,
  updateDoctor,
  deleteDoctor,
  uploadImage,
...
export default function Traditional3() {
  ...
  const [formData, setFormData] = useState({
    ...
    traditionalId: hospitalId ? parseInt(hospitalId) : null,
    addressLine1: "",
    addressLine2: "",
    mapLink: "",
    about: "",
...
const handleDeleteCategory = async (catId) => {
  ...
  try {
    const res = await getDoctorsByTraditionalId(hospitalId);
...
const groupDoctorsByCategory = () => {
  ...
  const handleEdit = (doc) => {
    setFormData({
      ...
      traditionalId: doc.traditionalId,
