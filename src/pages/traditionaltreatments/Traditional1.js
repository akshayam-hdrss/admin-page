...
import { deleteTraditionalType, getTraditionalType, updateTraditionalType, createTraditionalType, uploadImage, } from '../../api/api';
// import {
//   gettraditionalType,
      ...
      try {
        await Promise.all(
          categories.map(async (category) => {
            await deleteTraditionalType({ id: category.id });
          })
        );
        const response = await getTraditionalType();
        setCategories(response.data.resultData);
