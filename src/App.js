    ...
    <div className="app-container">
      ...
      <div className="content">
        <Routes>
          ...
          <Route
            path="hospital/:hospitalTypeId/categories/:categoryName/doctors"
            element={<HospitalDoctors />}
          />
          <Route
            path="/hospitals/:hospitalId/categories/:categoryName/doctors/:doctorId"
          ...
          <Route
            path="hospital-information/hospital/:hospitalId"
            element={<HospitalInfo />}
          />

          <Route path="/hospital/:hospitalTypeId" element={<HospitalArea />} />
          <Route
            path="/hospital/:hospitalTypeId/:hospitalId"
            element={<DoctorName />}
          />
          ...
          <Route
            path="/product/:productTypeId/:productId"
            element={<Productpage2 />}
          />
          <Route
            path="/product/:productTypeId/:productId/:productTypeId"
          ...
          <Route
            path="/service/:availableServiceTypeId"
            element={<ServicePage />}
          />
          <Route
            path="/service/:availableServiceTypeId/:availableServiceId"
            element={<ServicePage1 />}
          />
          <Route
            path="/service/:availableServiceTypeId/:availableServiceId/:serviceTypeId"
          ...
          <Route
            path="/traditional/:hospitalTypeId"
            element={<Traditional2 />}
          />
          <Route
            path="/traditional/:hospitalTypeId/:hospitalId"
            element={<Traditional3 />}
          />
